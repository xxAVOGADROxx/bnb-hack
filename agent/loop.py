    ...
    def __init__(self, cfg: AppConfig, paper_equity: float = 0.0):
        ...
        if cfg.risk.edge_floor_margin_pct > 0:
            try:
                ...
                # data/liquidity_report.json is a private per-server file (it
                # reveals the watchlist), generated by scripts/liquidity_filter.
                # Missing it disables the per-token edge floor (#9) — the
                # cooldown still applies. In LIVE mode that's worth shouting.
